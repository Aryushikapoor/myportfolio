...
const Contact = () => {
  return (
    ...
    <div className='bg-black/10 p-6 rounded-xl max-w-[550px]'>
     <h2 className='text-5xl font-bold text-orange-400 mb-4'>Let's Connect</h2>
     <p className='text-black/70 mb-6'>Send me a message and lets scheduel a call</p>
     <form className='space-y-4' action="https://getform.io/f/akkgqpva" method='POST'>
