...
const navLinks = [
    { title: "Home", path: "#home" }, // Home link
...
const Navbar = () => {
    ...
    return (
        <div className="text-black/70 pt-6 bg-[#FDFCDC]">
            <div className="hidden md:flex items-center px-4 py-2 mx-auto max-w-[500px] justify-center">
                <ul className="flex flex-row p-4 space-x-8">
                    {navLinks.map((link, index) => (
                        <li key={index}>
                            <Link href={link.path}>
                                <span>{link.title}</span> {/* Use span instead of p */}
                            </Link>
                        </li>
                    ))}
                    <li>
            ...
            <div onClick={toggleNav} className="md:hidden absolute top-5 right-5 border rounded text-black/70 border-black/70 p-2 z-50">
